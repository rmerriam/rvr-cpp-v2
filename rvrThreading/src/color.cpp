...
void color(rvr::SensorsDirect& sen_d) {
    ...
    std::cout << code_loc << "color sensing" << mys::nl;
    ...
    std::cout << code_loc << "currentRGBValues: " << c_r << mys::sp << c_g << mys::sp << c_b << mys::sp << c_c << mys::nl;
    std::cout << code_loc << "colorDetectionValues: " << (int)(d_r) << mys::sp << (int)(d_g) << mys::sp << (int)(d_b)
              << mys::sp << (int)(conf) << mys::sp << (int)(classification) << mys::nl;
    std::cout << code_loc << "isColorDetectionEnabled: " << sen_d.isColorDetectionEnabled().value() << mys::nl;
    std::cout << code_loc << "isColorDetectionNotifyEnabled: " << sen_d.isColorDetectionNotifyEnabled().value() << mys::nl;
    std::cout << code_loc << mys::nl;
