...
using Led = rvr::IoLed;
// defined to make it easier to access LedMask enum, i.e.
// Led::right_headlight_red
...
class IoLed : protected Request {
   ...
   void allLed(uint32_t const led_bits, RvrMsg const& colors, CommandResponse const want_resp = CommandResponse::resp_on_error) const;
